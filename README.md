...
2. Analysis with CRISPResso2 – Validated batch files are processed automatically, generating all required outputs. CRISPResso2 was developed by Kendell Clement and Luca Pinello from the Pinello Lab at Massachusetts General Hospital, USA.
